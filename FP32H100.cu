...
int main() {
    ...
    // 写输出文件
    writeOutputFile("h100_output.txt", testCases, results);
    ...
    std::cout << "H100 FP32 测试完成，结果已写入 h100_output.txt" << std::endl;
    //std::cout << "编译建议: nvcc -arch=sm_90 -o FP32H100 FP32H100.cu" << std::endl;
